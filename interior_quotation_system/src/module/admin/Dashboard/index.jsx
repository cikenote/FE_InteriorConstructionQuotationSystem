...
const StaffProjects = () => {
  ...
  const fetchGetNumberProducts = async () => {
    const response = await axios.get(
      "https://swp391api.developvn.click/api/Dashboard/GetNumberProducts"
    );
  ...
  const fetchGetNumberCategory = async () => {
    const response = await axios.get(
      "https://swp391api.developvn.click/api/Dashboard/GetNumberCategory"
    );
  ...
  const fetchGetNumberUsers = async () => {
    const response = await axios.get(
      "https://swp391api.developvn.click/api/Dashboard/GetNumberUser"
    );
  ...
  const fetchGetNumberContract = async () => {
    const response = await axios.get(
      "https://swp391api.developvn.click/api/Dashboard/GetNumberContract"
    );

...
const ShopItem = () => {
    ...
    const { isPending: productListLoading, mutate } = useMutation({
        mutationFn: () => ProductAPI.getProductList(currentPage),
        onSuccess: (response) => {
        ...
        <Spin tip="Loading..." spinning={productListLoading || isPending}>
            ...
            <div className="landing-page">
                <div className="content">
                    <h3 className="title">Đồ nội thất</h3>
                    <div className="links">
            ...
            <div className="pagination">
                <div className="content">
                    ...
                    {products.totalCount > 0 &&
                        Array.from(
                            Array(Math.ceil(products.totalCount / 10)).keys()
                        ).map((page) => {
                            return (
                                <div
                                    className={`item ${
